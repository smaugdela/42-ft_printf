...
#    Updated: 2021/09/01 13:25:12 by smagdela         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCD	=	sources/
SRCS	=	ft_printf.c ft_print_cpercent.c ft_utils.c ft_init_structspec.c ft_print_s.c ft_print_di.c ft_print_u.c  ft_print_x.c ft_print_p.c
